...
class shop_HP
{
    ...
    draw(){
        ...
        switch(this.hitPoint){
            case 4: vcon.drawImage(png_hp1, 0, 0, 1024, 420, 0, 0, 32, 16);
            break;
            case 3: vcon.drawImage(png_hp1, 0, 421, 1024, 512, 0, 0, 32, 16);
            break;
            case 2: vcon.drawImage(png_hp2, 0, 0, 1024, 420, 0, 0, 32, 16);
            break;
            case 1: vcon.drawImage(png_hp2, 0, 420, 1024, 512, 0, 0, 32, 16);
            break;
            case 0: vcon.drawImage(png_hp3, 0, 0, 1024, 512, 0, 0, 32, 16);
            break;
        }
    }
}
