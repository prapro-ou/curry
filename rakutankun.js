        ...
        if((this.x + 4) > 156 && (this.x + 4) < 166){
            if((this.y + 32) > 72 && (this.y + 32) < 82){
                if(keyboard.Go){
                    ...
                    //     window.location.href = 'normal_stage1.html'; 
                    // }
                    this.showDialog('normal_stage1.html', 'Let\'s go stage2');
                }
                keyboard.Go = false;
            }
        }
        ...
        if((this.x + 12) > 51 && (this.x + 12) < 61){
            if((this.y + 32) > 120 && (this.y + 32) < 130){
                if(keyboard.Go){
                    ...
                    //     window.location.href = 'normal_stage1.html'; 
                    // }
                    this.showDialog('normal_stage1.html', 'Let\'s go stage3');
                }
                keyboard.Go = false;
            }
        }
        ...
        if((this.x + 12) > 156 && (this.x + 12) < 166){
            if((this.y + 32) > 155 && (this.y + 32) < 165){
                if(keyboard.Go){
                    ...
                    //     window.location.href = 'normal_stage1.html'; 
                    // }
                    this.showDialog('normal_stage1.html', 'Let\'s go stage4');
                }
                keyboard.Go = false;
            }
        }
